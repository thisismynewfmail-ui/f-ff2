...
export class Game {
  ...
  async load(onProgress) {
    ...
    // The savable citizen: once the run is 100 kills deep, a chance every wave
    // to appear captured inside a random unlocked building — free her with [E]
    // for a health-kit drop. Takes the score so it can read that kill gate.
